...
# changelog, OpenSpec's structured change artifacts, and the PR template
# compose-box fragment, and holds them to house rules they were never
# written to (see openspec/changes/add-markdown-prose-linting/proposal.md).
